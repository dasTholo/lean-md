//! Vendored from lean-ctx core::signatures (regex-based; TS uses the generic regex path).
...
mod tests {
    ...
    fn tdd_legend_explains_only_present_symbols() {
        ...
        // Token budget check: legend should be reasonably short (≤15 words/tokens).
        assert!(legend.split_whitespace().count() <= 15, "{legend}");
